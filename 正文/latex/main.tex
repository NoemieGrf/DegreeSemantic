...
To study the linguistic features of gradable adjectives, Abney established the DegreeP Hypothesis in his research\cite{abney1987}. In DegreeP Hypothesis, the comparative and superlative forms of adjectives are analyzed as a functional category called Degree Phrase(DegP), 

\subsection{DegP-Shell}

\subsubsection{DegP-Shell in English}

\subsubsection{DegP-Shell in Mandarin}
