...
Examples shown in \ref{assignable_example_1} are classical expression in assignable meaning. 
...
\begin{enumerate}
    ...
    $[_{IP} NP [_{I'} I_0[_{...}[_{DegP}assignP[_{Deg'}Deg^0[_{AP}[A^0]]]]]]]$
\end{enumerate}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{pic/assignment_meaning.png}
    \begin{caption}
        \\ \vspace{-1.1ex}
