...
Another reason which supports the separation of lexical entries is the mistake mentioned in last section. If a positive form has "greater than" meaning in gradable adjective, a wrong result will be calculated which makes "\textit{John is 2 meters tall}" 
